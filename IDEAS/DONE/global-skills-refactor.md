...
verification, `/exe` останавливается и спрашивает оператора либо возвращает
...
- `/exe`, `/verify`, `/red-verify`, scheduler и `/mb-sync` сохраняют текущую
  ownership model.
...
`/spec-design`, `/feature-to-tasks`, `/foundation-to-tasks`, `/exe`, review и
