...
| api_interface_specs | .memory-bank/contracts/* | /spec-design, /prd-to-tasks | Generate/update Interface Specification: API Contract, Event Contract, protocol/agent/tool I/O, external, or frontend/backend interface specs when in scope. |
| data_specs | .memory-bank/domains/* and .memory-bank/states/* | /spec-design, /prd-to-tasks | Generate/update Data Specification: models, DB schemas, message/data formats, validation/serialization rules, lifecycle, retention, seed, or runtime data specs when in scope. |
| contract_specs | .memory-bank/contracts/* and .memory-bank/testing/* | /spec-design, /foundation-to-tasks, /prd-to-tasks | Generate/update Component Contract, API Contract, Event Contract, Data Contract, boundary, compatibility, evidence/redaction, safety/security, testing, runbook, or verification contracts when in scope. |
| foundation_substrate_specs | .memory-bank/architecture/*, .memory-bank/contracts/*, .memory-bank/domains/*, .memory-bank/testing/*, .memory-bank/runbooks/* | /foundation-to-tasks | Generate/update fundamental walking-skeleton substrate specs in baseline-proof scope: Architecture, Interface, Data, needed Component/API/Event/Data contracts, Test Harness, Local Runtime/Bootstrap, and Redaction/Evidence specs. Product-level detail is extended later by /prd-to-tasks. |
