...
> `DevRails 26` — **это фреймворк в связске с Codex\Claude, разворачиваемый вовнутрь проекта , в формате долгосрочной памяти и набора взаимосвязанных протоколов  для  полуавтоматической  разработки.**

  

Фреймворк ориентирован на джунов вайбкодеров, которые еще слабо разбираются во всех нюансах разработки небольших проектов до ~100к. строк кода.  
  
 Основные цели фреймворка:  
1. Обеспечить долгосрочную устойчивую поддержку проекта, благодаря предварительной проработке архитектуры и согласованных спецификаций.

2. Обеспечить наполнение свежей сессии агента  актуальным праймингом для продолжения работы с места остановки.   


Посе разворота DevRails в папку проекта ( частично разработанного или на стадии идеи)  разработка превращается в мягко направляемое агентами, но полностью контролируемое Вами движение по всем необходимым этапам разработки от мозгового штурма заканчивая e2e тестами.   
Плавную работу обеспечивают взаимосвязанные runtime-skills, JSON task registry,  Memory Bank, работающие поверх  бесшовных handoff протоколов.   
   

**🎛️ Как пользоваться**

- Можно  двигаться по рельсам самостоятельно, на лету поправляя Агентов, кующих проект и ревьювя изменения в кодовой и документальной базе. Агенты будут подсказывать следующий шаг workflow.
- Можно запустить автопилот, предварительно пройдя  brainstorming flow только для формирования PRD. В автопилоте все же придется уделять внимание Оркестратору раз в пару часов, принимая решенияна развилках. Такой процесс жрет куда больше токенов, результат может получиться местами с overhead кодом,  но будет  доведен до завершения, максимально экономя время разработчика.
