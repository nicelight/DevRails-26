#  DevRails — контролируемая фабрика агентов для разработки

![Схема DevRails 26](devrails.jpg)

> `DevRails 26` — **это фреймворк полуавтоматической Agentic разработки, разворачиваемый в ваш текущий проект  для Codex CLI или Claude Code.**

  Посе установки DevRails Ваш проект становится на рельсы из взаимосвязанных runtime-skills, Memory Bank, JSON task registry и протоколов, помогая разработчику пройти от идеи (или частично разработанной заготовки) до проверенной реализации.
   Фреймворк ориентирован на джунов, которые еще слабо разбираются во всех этапах проектирования софта.

**🎛️ Как пользоваться**

- Можно  двигаться по рельсам самостоятельно, на лету поправляя Агентов, кующих проект и ревьювя пошаговые изменения. Агенты будут подсказывать следующий шаг workflow.
